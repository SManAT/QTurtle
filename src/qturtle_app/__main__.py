...
from qturtle_app.ui.Ui_FTurtle import Ui_FTurtleWindow as Ui_FTurtle
...
class FTurtleWindow(QMainWindow):
    ...
    def _update_title(self):
        ...
        self.setWindowTitle(f"QTurtle (FTurtle) - {name}{modified}")
    ...
    def run_script(self):
        ...
        self.ui.consoleOutput.appendPlainText("(c) S.Hagmann\n")
...
class MainWindow(QMainWindow):
    ...
    def _connect_actions(self):
        ...
        self.ui.openFTurtleButton.clicked.connect(self.open_fturtle_window)
    ...
    def open_fturtle_window(self):
        self.fturtle_window: FTurtleWindow = FTurtleWindow()
        self.fturtle_window.show()
        self.close()
